...
\title{\bf \Huge{ACAN2515 library for Arduino\\Version 1.0.2}}
...
\begin{center}
  \begin{tabular}{llp{10cm}}
    ...
    1.0.2 & November 3, 2018 & Correct setting of \texttt{rtr} and \texttt{ext} properties on message receive (thanks to Arjan-Woltjer for having fixed this bug, \url{https://github.com/pierremolinaro/acan2515/pull/1}) \\
  \end{tabular}
\end{center}
