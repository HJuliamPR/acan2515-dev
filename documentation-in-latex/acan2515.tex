...
\title{\bf \Huge{ACAN2515 library for Arduino\\Version 1.0.4}}
...
\begin{center}
  \begin{tabular}{llp{10cm}}
    ...
    1.0.4 & November 23, 2018 & BugFix: transmit buffer \#2 size setting \\
          &                   & Transmit and send buffers properties are now \texttt{uint\_16} (instead of \texttt{uint\_32}), for saving memory \\
          &                   & \texttt{ACAN2515::begin} now returns an \texttt{uint\_16} (instead of \texttt{uint\_32})
  \end{tabular}
\end{center}
