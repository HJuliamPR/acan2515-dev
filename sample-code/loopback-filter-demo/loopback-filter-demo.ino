...
//   RECEIVE FILTERS
//——————————————————————————————————————————————————————————————————————————————
//   For testing filters, we define six types of CAN messages:
//   extended frame, identifier 0x12345678 --> received by acceptance filter #0
//   extended frame, identifier 0x18765432 --> received by acceptance filter #1
